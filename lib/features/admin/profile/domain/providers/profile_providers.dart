...
import 'package:attendance_cnn_app/features/admin/profile/data/repository/profile_repository_impl.dart';
...
final profileRepositoryProvider = Provider(
  (ref) => ProfileRepositoryImpl(
    profileRemoteDataSource: ref.watch(profileRemoteDataSource),
  ),
);
